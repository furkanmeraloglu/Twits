    ...
    <div class="bg-white shadow">
        <div class="container mx-auto flex flex-col lg:flex-row items-center lg:relative">
            ...
            <div class="w-full lg:w-1/4 flex my-4 lg:my-0 lg:justify-end items-center">
                <div class="mr-6">
                    <button class="bg-teal hover:bg-teal-dark text-black font-medium py-2 px-4 rounded-full">Following</button>
                </div>
        ...
        <div class="w-full lg:w-1/2 bg-white mb-4">
            ...
            <div class="flex border-b border-solid border-grey-light">
                <div class="w-1/8 text-right pl-3 pt-3">
                    ...
                    @else
                    <div><a href="#"><img src="{{$tweet->user->image_path}}" alt="avatar" class="rounded-full h-12 w-12 mr-2"></a></div>
                    @endif
                </div>
        ...
        <div class="w-full lg:w-1/4 pl-4">
            <div class="bg-white p-3 mb-3">
                ...
                <div class="flex border-b border-solid border-grey-light">
                    <div class="py-2">
                        @if($user->image_path === null)
                    <div><a href="{{ route('users.show', $user) }}"><img src="https://source.unsplash.com/400x400" alt="avatar" class="rounded-full h-12 w-12 mr-2"></a></div>
                    @else
                    <div><a href="{{ route('users.show', $user) }}"><img src="{{ 'images/' . $user->image_path }}" alt="avatar" class="rounded-full h-12 w-12 mr-2"></a></div>
                    @endif
                    </div>
                    <div class="pl-2 py-2 w-full">
                        <div class="flex justify-between mb-1">
                            <div>
                                <a href="{{ route('users.show', $user) }}" class="font-bold text-black">{{$user->name}}</a> <a href="#" class="text-grey-dark">@'{{$user->nickname}}'</a>
                            </div>

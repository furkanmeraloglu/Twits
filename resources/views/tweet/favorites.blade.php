<x-app-layout>
    ...
    @else
        <div class="hero h-64 bg-cover h-112 full"
            style="background-image: url({{ asset('images/' . $user->bg_image_path) }})"> </div>
    @endif
